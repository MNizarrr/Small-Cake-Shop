...
export default function Navbar() {
  ...
  const location  = useLocation() // ← trigger re-render setiap ganti halaman
  ...
  return (
    <nav className="bg-white shadow-sm sticky top-0 z-50">
      <div className="max-w-6xl mx-auto px-4 py-3 flex items-center justify-between">
        ...
        <Link to={role === 'admin' ? '/admin' : '/'} className="flex items-center gap-2 text-pink-500 font-bold text-xl">
