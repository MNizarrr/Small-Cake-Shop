  ...
  return (
    <div className="max-w-6xl mx-auto px-4 py-10">
      ...
      <div className="bg-gradient-to-r from-pink-500 to-pink-400 rounded-2xl p-8 mb-10 text-white flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-bold mb-2">Kue Lezat untuk Setiap Momen</h1>
          <p className="text-pink-100 mb-4">Pesan kue favoritmu sekarang, diantarkan langsung ke pintu rumahmu.</p>
          <a href="#produk" className="bg-white text-pink-500 font-semibold px-5 py-2 rounded-full text-sm hover:bg-pink-50 transition">
            Lihat Produk
          </a>
        </div>
      ...
      <div id="produk">
        ...
        {loading ? (
          ...
          <div className="text-center text-gray-400 py-20">Belum ada produk tersedia.</div>
        ) : (
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
            {products.map(product => (
              <div key={product.id} className="bg-white rounded-2xl shadow-sm hover:shadow-md transition overflow-hidden group">
                {/* Gambar */}
